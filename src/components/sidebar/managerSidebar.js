    ...
    <div class="sidebar-content">
          ...
          <ul class="submenu visible">
            ...
            <li>
              <a href="/manager-request">
                <span class="sub-icon">
                  <img src="../../../public/icon/category.svg" alt="행정 자료 요청">
                </span>
        ...
        <li>
          ...
          <ul class="submenu visible">
            <li>
              <a href="/student-attendance-record">
                <span class="sub-icon">
                  <img src="../../../public/icon/category.svg" alt="수강생 출결 현황">
                </span>
          ...
          <li>
            <a href="/manager-going-out">
              <span class="sub-icon">
                <img src="../../../public/icon/category.svg" alt="외출/조퇴 관리">
              </span>
          ...
          <li>
            <a href="/manager-vacation">
              <span class="sub-icon">
                <img src="../../../public/icon/category.svg" alt="휴가 관리">
              </span>
          ...
          <a href="/manager-public-house" class="has-submenu">
              <span class="sub-icon">
                <img src="../../../public/icon/category.svg" alt="공가 관리">
              </span>
      ...
      <li>
        <a href="/student-info" class="has-submenu">
          <span class="icon">
            <img src="../../../public/icon/iconUser1.svg" alt="수강생 리스트">
          </span>
